                ...
                <div class="position-relative mb-3">
                    ...
                    <div class="d-flex justify-content-between bg-white border border-top-0 p-4">
                        <div class="d-flex align-items-center">
                            <img class="rounded-circle mr-2" src="./admin_dashboard/employee/employee_profile_image/<?php echo $singleNews[0]["employeeImage"] ?>" width="25" height="25" alt="">
                            <span><?php echo $singleNews[0]["employeeName"] ?></span>
                        </div>
                        <div class="d-flex align-items-center">
                            <span class="ml-3"><i class="far fa-eye mr-2"></i><?php echo $viewsCount ?></span>
                            <span class="ml-3"><i class="far fa-comment mr-2"></i><?php echo count($allComments); ?></span>
                        </div>
                    </div>
                </div>
                <!-- News Detail End -->
                    ...
                    <div class="bg-white border border-top-0 p-4" id="comment-list">
                        ...
                        <?php foreach ($allComments as $comment) { ?>
                            <div class="media mb-4">
                                <img src="./user_avatar/<?php echo $comment["userImage"]; ?>" alt="Image" class="img-fluid mr-3 mt-1" style="width: 45px;">
                                <div class="media-body">
                                    <h6><a class="text-secondary font-weight-bold" href=""><?php echo $comment["username"]; ?></a> <small><i><?php echo $comment['comment_date'] ?></i></small></h6>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $("#comment-list").append(`<div class="media mb-4">
                        ...
                        <div class="media-body">
                            <h6><a class="text-secondary font-weight-bold" href="">${comment.username}</a> <small><i>${comment.comment_date}</i></small></h6>
                            <p>${comment.message}</p>
                ...
                mediaBody.find(".submitReply").on("click", function(e) {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            mediaBody.find('.replyDiv').append(`<p>${response.message}</p>`);
                        },
